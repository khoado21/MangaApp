...
export default function Genres() {
    return (
        <Stack.Navigator>
            <Stack.Screen name="list_genres" component={ListGenres} options={{ title:'Danh sách thể loại'  }} />
            <Stack.Screen name="list_by_genres" component={ListByGenres} options={({route})=> ({ title:route.params.name })} />
