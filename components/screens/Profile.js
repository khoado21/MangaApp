            ...
            <ScrollView
                ...
                <View style={styles.userInfoSection}>
                    ...
                    <View style={styles.row}>
                        <Icon name="gender-male" color="#777777" size={20}/>
                        <Text style={{color:"#777777", marginLeft: 20}}> {dataUser?.gioitinh} </Text>
                    </View>
                    <View style={styles.row}>
                        <Icon name="email" color="#777777" size={20}/>
                        <Text style={{color: COLORS.lightGray3, marginLeft: 20}}> {auth.currentUser?.email} </Text>
                    </View>
                </View>
